...
export default function RaceStatus({
  ...
  return (
    <div
      className="rounded-xl p-5 mb-6 grid gap-4"
      style={{
    ...
    >
      ...
      {currentSegment && (
        <div className="flex flex-col gap-1 px-2">
          ...
          <span className="text-sm text-white">{currentSegment.route_name}</span>
          <span className="text-sm" style={{ color: 'var(--color-text-muted)' }}>
            {currentSegment.distance_km} km &bull; Pace projetado:{' '}
      ...
      {nextSegment && (
        <div className="flex flex-col gap-1 px-2">
          ...
          <span className="text-sm" style={{ color: 'var(--color-text-muted)' }}>
            {nextSegment.distance_km} km &bull; Largada est:{' '}
